...
```sql
SELECT COUNT(1)
  FROM `taxi_dataset.yellow_tripdata`
  -- WHERE filename LIKE "%2020%"; -- Alternative approach
...
```sql
SELECT COUNT(1)
  FROM `taxi_dataset.green_tripdata`
  -- WHERE filename LIKE "%2020%"; -- Alternative approach
...
SELECT COUNT(1)
  FROM `taxi_dataset.yellow_tripdata`
  -- WHERE filename LIKE "%2021-03%"; -- Alternative approach
